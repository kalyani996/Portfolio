...
const skills = [
    ...
    { name: 'Knockout.js', level: '60', category: "frontend" },
    ...
    { name: 'Magento 2', level: '70', category: "ecommerce" },
    { name: 'REST APIs', level: '80', category: "backend" },

    { name: 'Docker', level: '60', category: "tools" },
    { name: 'Kubernetes', level: '50', category: "tools" },
...
const categories = ['all', 'frontend', 'backend', 'ecommerce', 'tools'];
